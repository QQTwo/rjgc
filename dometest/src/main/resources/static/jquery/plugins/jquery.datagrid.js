...
(function ($) {
            ...
            if (col && col.editor) {
                ...
                if (_15d) {
                    ...
                    $.data(cell[0], "datagrid.editor", {
                        actions: _15d,
                        target: _15d.init(cell.find("td"), _15c),
                        field: _15a,
                        type: _15b,
                        oldHtml: _15e
                    });
    ...
    $.fn.datagrid.methods = {
        options: function (jq) {
            ...
            var opts = $.extend(_1c0, {
                width: _1c1.width,
                height: _1c1.height,
                closed: _1c1.closed,
                collapsed: _1c1.collapsed,
                minimized: _1c1.minimized,
                maximized: _1c1.maximized
            });
            return opts;
    ...
    $.fn.datagrid.parseOptions = function (_1ed) {
        var t = $(_1ed);
        return $.extend({}, $.fn.panel.parseOptions(_1ed), $.parser.parseOptions(_1ed, ["url", "toolbar", "idField", "sortName", "sortOrder", "pagePosition", "resizeHandle", {
    ...
    var _1f0 = {
        render: function (_1f1, _1f2, _1f3) {
